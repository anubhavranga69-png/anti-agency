      ...
      <main className="flex-1 pt-28 pb-20">
        ...
        <section className="relative overflow-hidden py-16 sm:py-24">
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-0 left-1/3 w-[600px] h-[600px] bg-[#E40101]/8 rounded-full blur-[160px]" />
          </div>
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-zinc-900 border border-zinc-800 text-xs font-semibold text-[#E40101] uppercase tracking-wider mb-6">
              About Anti-Agency
            </div>
            <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl text-white font-bold uppercase tracking-tight leading-tight mb-6">
              ...
              <span className="text-[#E40101]">Brands.</span>
              <br />
              We Help Build Them.
            </h1>
            <div className="max-w-3xl space-y-4 text-zinc-300 text-sm sm:text-base leading-relaxed">
              ...
              <p className="text-zinc-400 italic border-l-2 border-[#E40101] pl-4">
        ...
        <section className="py-16 border-t border-zinc-800/60">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-xs font-mono text-[#E40101] uppercase tracking-wider mb-4">
                  Why We Started
                </div>
                <h2 className="font-heading text-3xl sm:text-4xl text-white font-bold uppercase tracking-tight leading-tight mb-5">
                  Built Around <span className="text-[#E40101]">Focus,</span> Not Volume
                </h2>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="font-heading text-3xl sm:text-4xl text-white font-bold uppercase tracking-tight leading-tight">
                ...
                <span className="text-[#E40101]">3–4 Clients Per Quarter</span>
              </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {whySmall.map((item, i) => (
                <div
                  key={i}
                  className="glass-card glass-card-hover rounded-2xl p-6 border border-zinc-800"
                >
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-[#E40101] shrink-0 mt-0.5" />
                    <div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="font-heading text-3xl sm:text-4xl text-white font-bold uppercase tracking-tight leading-tight mb-4">
                  End-to-End <span className="text-[#E40101]">Brand Building</span>
                </h2>
                ...
                <ul className="space-y-2">
                  {services.map((s, i) => (
                    <li key={i} className="flex items-center gap-2.5 text-sm text-zinc-200">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#E40101] shrink-0" />
                      {s}
                    </li>
                  ))}
                </ul>
                <a
                  href="/services"
                  className="inline-flex items-center gap-2 mt-6 text-xs font-bold uppercase tracking-wider text-white bg-[#E40101] hover:bg-[#ff1a1a] px-5 py-2.5 rounded-full shadow-lg shadow-[#E40101]/25 transition-all hover:-translate-y-0.5"
                >
                  View All Services
              ...
              <div className="glass-card rounded-2xl p-6 border border-zinc-800">
                <div className="flex items-center gap-2 mb-5">
                  <Globe className="w-5 h-5 text-[#E40101]" />
                ...
                <div className="flex flex-wrap gap-2">
                  {regions.map((r) => (
                    <span
                      key={r}
                      className="px-3 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-xs font-semibold text-zinc-200 hover:border-[#E40101]/50 transition-colors"
                    >
                      {r}
                    </span>
                  ))}
        ...
        <section className="py-20 border-t border-zinc-800/60">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-xs font-mono text-[#E40101] uppercase tracking-wider mb-5">
              Looking Forward
            </div>
            <h2 className="font-heading text-3xl sm:text-4xl text-white font-bold uppercase tracking-tight leading-tight mb-4">
              Working With You
            ...
            <a
              href="/#hero-enquiry"
              className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-wider text-white bg-[#E40101] hover:bg-[#ff1a1a] px-8 py-3.5 rounded-full shadow-xl shadow-[#E40101]/30 hover:shadow-[#E40101]/50 transition-all hover:-translate-y-0.5"
            >
