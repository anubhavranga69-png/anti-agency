    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        <a href="/" className="flex items-center gap-3 group">
          <div className="relative w-10 h-10 flex items-center justify-center rounded-md bg-zinc-900 border border-zinc-800 group-hover:border-[#7c93a3]/50 transition-all duration-300 group-hover:shadow-[0_0_20px_rgba(124,147,163,0.3)]">
        ...
        <nav className="hidden md:flex items-center gap-1 bg-zinc-900/60 border border-zinc-800/80 rounded-md px-5 py-2 backdrop-blur-md">
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
        ...
        <button
          ...
          className="md:hidden p-2 rounded-md bg-zinc-900 border border-zinc-800 text-zinc-300 hover:text-white"
            ...
            <nav className="flex flex-col space-y-3 w-full">
              {navLinks.map((link) => (
                <a
                  ...
                  className="relative text-sm font-semibold uppercase tracking-wider text-zinc-300 hover:text-[#7c93a3] py-2 border-b border-zinc-900"
                >
                  {link.name}
                </a>
              ))}
